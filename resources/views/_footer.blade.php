<footer class="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="max-w-xl lg:max-w-lg">
            ...
            <p class="mt-4 text-lg leading-8 text-gray-300">Get information about our new updates and features.</p>
        ...
        <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            ...
            <dd class="mt-2 leading-7 text-gray-400">Update the website on a weekly basis.</dd>
            </div>
            <div class="flex flex-col items-start">
            <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <dd class="mt-2 leading-7 text-gray-400">Send just one or two newsletters a week to ensure that there is no spamming.</dd>
            </div>
        </dl>
        </div>
    </div>
